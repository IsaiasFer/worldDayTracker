// Mapping of ISO 3166-1 numeric codes (as strings) to ISO 3166-1 alpha-2 codes.
// This is used to convert the numeric IDs from the world-atlas topology to alpha-2 codes for flag generation.
